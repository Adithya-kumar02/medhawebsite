...
const Register = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.phone) newErrors.phone = "Head Phone no is required";
      ...
      newErrors.phone = "Head Phone no must be exactly 10 digits";
    }
    ...
    if (!formData.hodPhone) newErrors.hodPhone = "HOD Phone no is required";
    else if (!/^\d{10}$/.test(formData.hodPhone)) {
      newErrors.hodPhone = "HOD Phone no must be exactly 10 digits";
    }
    ...
    return (
      ...
      >
        ...
        >
          ...
          <button
            onClick={() => window.open("https://forms.gle/o9E9C3zeTuq4sUha8", "_blank")}
            style={{
              marginTop: "20px",
              padding: "10px 20px",
              marginLeft: "40px",
  ...
  {errors.hodPhone && <span className="error">{errors.hodPhone}</span>}
          ...
          <button type="button" className="pay-button" onClick={() => {
            if (validateForm()) {
              paymentHandler();
              //window.location.href = "https://forms.gle/o9E9C3zeTuq4sUha8"
              console.log("yes");
            } else {
